...
const levelDataDict = [
  {
    ...
    lockOpenImg: '/src/assets/user-level/charm-level/level-1/lock-open.png',
  ...
  },
  {
    ...
    lockOpenImg: '/src/assets/user-level/charm-level/level-2/lock-open.png',
  ...
  },
  {
    ...
    lockOpenImg: '/src/assets/user-level/charm-level/level-3/lock-open.png',
  ...
  },
  {
    ...
    lockOpenImg: '/src/assets/user-level/charm-level/level-4/lock-open.png',
...
const charmImages = import.meta.glob('/src/assets/user-level/charm-level/**/*', {
  eager: true,
  import: 'default',
})
...
onMounted(() => {
  ...
  emit('editHeaderContainerSelector', '#header-container-selector-charmLevel')
})
